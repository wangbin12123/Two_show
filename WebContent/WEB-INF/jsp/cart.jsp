    ...
    <table class="table" style="margin-top: 10px">
        <tbody>
            ...
            <tr>
                ...
                <td><br><br></td>
                <td><br><input type="number" id="num"  value="${countNum}" min="1" max="1000" step="1"/></td>
...
<div class="container" style="background: #fff; padding: 0">
    <div class="jiesuan">
        ...
        <div class="jiesuan-right" >
            <span>已选商品<span class="red-font">${countNum}</span>件</span>
            <span>总金额(不含运费)：¥<span class="red-font" >${product.price*countNum}</span>元</span>
